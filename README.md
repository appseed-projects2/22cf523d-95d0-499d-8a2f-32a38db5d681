...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-21 19:34`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/22cf523d-95d0-499d-8a2f-32a38db5d681.git
$ cd 22cf523d-95d0-499d-8a2f-32a38db5d681
```
